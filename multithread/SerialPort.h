...
//使用说明：
//先声明CSerialPort SerialPort;
//调用SerialPort.InitPort(4, 115200)打开串口（串口号，波特率）
//SerialPort.OpenListenThread()打开监听
//cRecved储存读回数据
//SerialPort.WriteData(a, 1)发送
//
//版权就交给你了
//2017.1.16
/////////////////////////////////////////////////////////////////
...
extern unsigned char Rec_buffer[COUNT];
