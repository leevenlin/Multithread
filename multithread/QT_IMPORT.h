...
typedef int (__stdcall *PFUNNQTSENDDATA) (ST_CARDINFO *pstCardInfo,void *pBufSrc,unsigned int unLen,unsigned int unTimeOut);
...
extern "C"
#endif
  int __stdcall QTSendData (ST_CARDINFO *pstCardInfo,void *pBufsrc,unsigned int unLen,unsigned int unTimeOut);
#ifdef __cplusplus
extern "C"
#endif
