/*
Defines for the QueenTest All series board
Created by zhangwenchao 2015/06/03
*/
/////////////////////////////////////////////
...
//#define COUPLE_DC
#define COUPLE_AC
//#define _QTFIRMWARE_QT1138_LEGACY_DATAFORMAT_H_
//#define CALDATA_IN_FILE
#define AUTO_CALIBRATION
//end---------------------------------------

#ifdef COUPLE_DC
  #ifdef _QTFIRMWARE_QT1138_H_
    #define DAC_NUM 4
    #define INPUT_RANGE_NUM 4
    #define GAIN_STEP_NUM 4//fixed number for 3 stage PGA
  #elif defined(_QTFIRMWARE_QT1125_H_)
    #define DAC_NUM 4
    #define INPUT_RANGE_NUM 4
    #define GAIN_STEP_NUM 81
  #else
  #endif
#else
  #define DAC_NUM 4
...
//ADDA Register
#define REGISTER_ADDA_BASEADDR                      0x7ae00000//基地址
...
// user register
#define REGISTER_USER_BASEADDR                      0x78200000//Base address of user specific registers
//Commands
//Commit
...
//To be revised
#define DMABUFCNT                                   2
#define DRV_MALLOC_LEN_FOR_DMA                      0x2000000 //0x100000 is 32 MB
#define EACH_DMA_MAX_LEN                            (DRV_MALLOC_LEN_FOR_DMA/8) //tx max len is 8MB.
#define EACH_DMA_RX_MAX_LEN                         (EACH_DMA_MAX_LEN/2) //rx max len is 4MB.
#define EACH_DMA_MIN_LEN                            0x20
//To be revised
...
{
  QTFM_INPUT_RANGE_1                     = 0,  //1X +full_scale in mV, X = 0.5V
  QTFM_INPUT_RANGE_2,                          //2X +full_scale in mV
  QTFM_INPUT_RANGE_3,                          //5X +full_scale in mV
  QTFM_INPUT_RANGE_4,                          //10X +full_scale in mV
  QTFM_INPUT_RANGE_5                           //10X +full_scale in mV
...
{\
  ...
  sprintf_s (szText,sizeof(szText),"Error %s:%#x(Line:%d)\n",#value,nRet,__LINE__);\
